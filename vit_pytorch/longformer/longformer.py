...
#     def __init__(self, hidden_size: int, heads: int, attention_window: int=256, attention_dilation: int=1, 
#         attention_mode: str='sliding_chunks', auto_regressive: bool=False, dropout: float=0.):
#         """
#         Args:
